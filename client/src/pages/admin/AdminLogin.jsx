      ...
      <div className="bg-white flex rounded overflow-hidden">
        ...
        <div className="w-[25rem] px-8 py-20 relative overflow-hidden">
          ...
          <form className="text-sm flex flex-col gap-4 mt-6">
            ...
            <button
              type="submit"
              className="bg-radial-[at_-50%_-50%] from-green-500 to-emerald-600 to-75% text-white rounded py-2 px-8 mt-4 font-semibold uppercase active:scale-95 transition-all "
            >
              Login
            </button>
          </form>
