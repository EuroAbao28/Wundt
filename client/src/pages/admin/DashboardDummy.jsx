  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* <div className="mt-6 flex gap-4 flex-1">
        <div className="flex-1 shadow-card2 rounded flex flex-col">
          <h1 className="font-semibold p-6">Today's Appointments</h1>
          <div className="flex-1 relative overflow-y-scroll scrollbar scrollbar-thin scrollbar-thumb-red-500">
        ...
        <div className="flex-1 shadow-card2 p-6">
